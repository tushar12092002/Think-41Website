...
const Boot41Flow = () => (
  <section className="pl-[34px] h-[496px] bg-white relative flex justify-center items-start mt-[64px] w-full">
    <div className="absolute w-[1107px] h-[172px] top-[150px] left-0">
      ...
      {/* Arrow on the curve */}
      <img src={Polygon} alt="arrow" className="absolute left-[205px] top-[150px] w-[10px] h-[10px] rotate-[120.812deg] z-[2]" />
    ...
    <div className="pl-[34px] w-[1440px] h-[496px] relative">
      ...
      <span className="absolute left-[640px] top-[250px] font-['Roboto'] text-[122.093px] font-semibold bg-gradient-to-b from-[#D6D7DB] to-[#FFF] bg-clip-text text-transparent z-0 pointer-events-none">2</span>
      <span className="absolute right-0  left-[1100px] top-[-60px] font-['Roboto'] text-[122.093px] font-semibold bg-gradient-to-b from-[#D6D7DB] to-[#FFF] bg-clip-text text-transparent z-0 pointer-events-none">3</span>
