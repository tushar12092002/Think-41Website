  ...
  return (
    <div ref={timelineRef} className="container mx-auto px-4 py-16 max-w-6xl relative">
      ...
      <TimelineSection
        ...
        gradientNumber={true}      // apply gradient
      />
    </div>
  )
}
    ...
    >
      ...
      {showNumber ? (
        <motion.div
          ...
          className={`text-9xl font-bold flex justify-center items-start pt-4 ${
            gradientNumber
      ...
      <div className="pt-4 text-left">
        <motion.h2 variants={contentVariants} className="text-2xl font-bold text-gray-800 mb-4 text-left">
          {title}
        </motion.h2>
