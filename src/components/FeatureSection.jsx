...
export default function FeatureSection() {
  return (
    <div>
      ...
      <div className="bg-[linear-gradient(to_top,#85a4f8_0%,#85a4f8_20%,_#a7bcf6_30%,_transparent_50%,_white_100%)] w-full flex justify-center h-[500px] relative">
        ...
        <div className="grid md:grid-cols-3 gap-8 ">
          {features.map((feature, idx) => (
            ...
            >
              ...
              <h3 className="feature-title relative text-[1.35rem] font-semibold text-[#222] mb-4 z-10">{feature.title}</h3>
              <p className="feature-desc relative text-gray-700 text-base z-10">{feature.desc}</p>
            </div>
          ))}
        </div>
      </div>
...
// export default function FeatureSection() {
//   return (
//     <div className="bg-gradient-to-t from-blue-200 to-white w-full">
//       <div className="grid-bg w-full">
//         <div className="container mx-auto px-4 py-16">
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//             {features.map((feature, idx) => (
//               <div key={idx} className="feature-card bg-blue-50 rounded-lg overflow-hidden shadow-sm">
//                 <div className="p-8">
